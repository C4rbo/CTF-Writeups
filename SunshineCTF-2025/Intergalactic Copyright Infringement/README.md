# Intergalactic Copyright Infringement - Writeup

In this writeup I will explain a network CTF where I need to extract a PDF file via the BitTorrent protocol. 
